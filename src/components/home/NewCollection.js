...
export default function NewCollection({data}) {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.content}>
                <Text style={styles.text1}>New Arrival</Text>
                <TouchableOpacity style={styles.text2} onPress={() => navigation.push("NewArrivalProductsList")}>
