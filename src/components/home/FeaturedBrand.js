...
export default function FeaturedBrand({data}) {
    ...
    function _renderItem({ item, index }) {
        return (
            <View style={{flex:1,marginBottom:4,borderColor:'#cccccc',borderWidth:0.5}}>
    ...
    return (
        <View style={styles.container}>
            <View style={styles.content}>
                <Text style={styles.text1}>Featured Products</Text>
                <TouchableOpacity style={styles.text2} onPress={() => navigation.push("FeaturedProductsList")}>
...
//             }]}
//                 onPress={() => navigation.push("ListScreen")}>
...
//         <View style={styles.container}>
//             <View style={styles.content}>
//                 <Text style={styles.text1}>Featured Brands</Text>
//             </View>
//             <FlatList
//                 data={data}
//                 renderItem={_renderItem}
...
//         alignSelf:'center'
//     },
//     img: { height: 40, width: 40,borderRadius:20,alignSelf:'center' },
//     subTxt: {
//         fontSize: 10,
//         fontWeight: "bold",
//         marginTop: 0,
